...
* The ESP8266 is a dirtcheap wifimodule.
...
## Install
* Download the library as a zip from 
https://github.com/Reyzshvrootkit/ESP8266-ControlSystem/blob/master/ESP8266wifi.zip
* Unzip and place in Your directory as ESP8266wifi
